...
from NodeCFR.CSGamer import *
from NodeCFR.VanillaGamer import *
...
# Enriching the nodes and abstract infosets dataframe
    ...
    abs_infosets, pl = U.chance_to_infoset(nodes, infosets, abs_infosets)
    if method == 'public_chance':
        chance_sampling_cfr = CSGamer(nodes)
    ...
    for i in abs_infosets.index:
        probos.append(chance_sampling_cfr.nash_equilibrium[i])
